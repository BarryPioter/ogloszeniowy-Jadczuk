...
<div id="content" class="container-fluid">
 ...
 <?php
   ...
   if (isset($_SESSION['nick'])||isset($_SESSION['id'])) {
      $wynik = mysqli_query($conn, "SELECT id,item,data,cena FROM ogloszenia WHERE id_user=".$_SESSION['id']." and `widok` =1")
	  or die('B&#322;&#261;d zapytania'); 
	  if(mysqli_num_rows($wynik) > 0) { 
 echo "<center>";
 echo "Twoje ogloszenia:";
...
echo "<td><strong>Operacje</strong></td>";
 echo "</tr>";
    ...
    while($r = mysqli_fetch_array($wynik)) { 
        ...
        echo "<td>".$r[2]."   </td>"; 
		echo "<td>".$r[3]." zł</td>";
		echo "<td><a href=\"usun.php?a=del&amp;id={$r[0]}\">Usu&#324;/Zako&#324;cz</a>       <a href=\"wyroznij.php?a=del&amp;id={$r[0]}\">Wyroznij</a></td>";
        echo "</tr>"; 
    } 
    echo "</table>"; 
}
